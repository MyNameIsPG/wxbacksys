...
public class ActivityController extends BaseController{
	...
	public ReturnResult queryActivityForMyself(int pageNum,int pageSize,Integer status){
		...
		Page page = PageHelper.startPage(pageNum, pageSize);
		List<Map<String,Object>> list = activityService.queryActivityForMyself(paramMap);
		return ReturnResult.pageOk(list, page.getTotal(), page.getPages());
	}
